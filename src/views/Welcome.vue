...
<template>
  ...
  <div class="welcome">
    ...
    <p>
      This page is intended for use by tour guides of the open house tour. It
      contains information on the participants registered for each route, and
      allows guides to sign up on behalf of senior citizens who are less
